...
class classwsCreateGroupResponseTest extends PHPUnit_Framework_TestCase
{
    ...
    */
    ...
    {
        $this->object = new wsCreateGroupResponse();
    }
    ...
    */
    ...
    {
        $methods = get_class_methods('wsCreateGroupResponse');        $this->assertTrue( count($methods) == 1);
    }
    ...
    */
    public function test__construct()
    {
        ...
        $r = new ReflectionMethod('wsCreateGroupResponse', '__construct');
        ...
        $this->assertTrue( $params[2]->getName() == 'groupUID');
