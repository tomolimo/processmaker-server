...
{
    /**
     * @var dashletProcessMakerEnterprise
    */
    protected $object;
    ...
    */
    ...
    {
        $this->object = new dashletProcessMakerEnterprise();
    }
    ...
    */
    ...
    {
        $methods = get_class_methods('dashletProcessMakerEnterprise');        $this->assertTrue( count($methods) == 4);
    }
    ...
    */
    public function testgetAdditionalFields()
    {
        ...
        $r = new ReflectionMethod('dashletProcessMakerEnterprise', 'getAdditionalFields');
    ...
    */
    public function testgetXTemplate()
    {
        ...
        $r = new ReflectionMethod('dashletProcessMakerEnterprise', 'getXTemplate');
        $params = $r->getParameters();
        $this->assertTrue( $params[0]->getName() == 'className');
        $this->assertTrue( $params[0]->isArray() == false);
        $this->assertTrue( $params[0]->isOptional () == false);
    ...
    */
    public function testsetup()
    {
        ...
        $r = new ReflectionMethod('dashletProcessMakerEnterprise', 'setup');
        $params = $r->getParameters();
    ...
    */
    public function testrender()
    {
        ...
        $r = new ReflectionMethod('dashletProcessMakerEnterprise', 'render');
        $params = $r->getParameters();
