...
class classwsCreateUserResponseTest extends PHPUnit_Framework_TestCase
{
    ...
    */
    ...
    {
        $this->object = new wsCreateUserResponse();
    }
    ...
    */
    ...
    {
        $methods = get_class_methods('wsCreateUserResponse');        $this->assertTrue( count($methods) == 1);
    }
    ...
    */
    public function test__construct()
    {
        ...
        $r = new ReflectionMethod('wsCreateUserResponse', '__construct');
