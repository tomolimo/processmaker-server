...
class classXmlForm_Field_TextPMTest extends PHPUnit_Framework_TestCase
{
    ...
    */
    ...
    {
        $this->object = new XmlForm_Field_TextPM();
    }
    ...
    */
    ...
    {
        $methods = get_class_methods('XmlForm_Field_TextPM');        $this->assertTrue( count($methods) == 24);
    }
    ...
    */
    public function testrender()
    {
        ...
        $r = new ReflectionMethod('XmlForm_Field_TextPM', 'render');
    ...
    */
    public function testrenderGrid()
    {
        ...
        $r = new ReflectionMethod('XmlForm_Field_TextPM', 'renderGrid');
        $params = $r->getParameters();
    ...
    */
    public function testattachEvents()
    {
        ...
        $r = new ReflectionMethod('XmlForm_Field_TextPM', 'attachEvents');
        $params = $r->getParameters();
