...
class classpopupMenuTest extends PHPUnit_Framework_TestCase
{
    ...
    */
    public function testrenderPopup()
    {
        ...
        $this->assertTrue( in_array('renderPopup', $methods ), 'exists method renderPopup' );
        $r = new ReflectionMethod('popupMenu', 'renderPopup');
        $params = $r->getParameters();
        $this->assertTrue( $params[0]->getName() == 'tableId');
