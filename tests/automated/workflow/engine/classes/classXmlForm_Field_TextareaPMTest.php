...
class classXmlForm_Field_TextareaPMTest extends PHPUnit_Framework_TestCase
{
    ...
    */
    ...
    {
        $this->object = new XmlForm_Field_TextareaPM();
    }
    ...
    */
    ...
    {
        $methods = get_class_methods('XmlForm_Field_TextareaPM');        $this->assertTrue( count($methods) == 24);
    }
    ...
    */
    public function testrender()
    {
        ...
        $r = new ReflectionMethod('XmlForm_Field_TextareaPM', 'render');
