...
MainPanel = function() {
	MainPanel.superclass.constructor
			.call(
					this,
					{
						id : 'doc-body',
									...
									tbar : [
											{
												...
												listeners : {
													render : function(f) {
														Ext
																.getCmp("startCaseTreePanel").filter = new Ext.tree.TreeFilter(
																this,
																{
																	clearBlank : true,
																	autoClear : true
											...
											' ',
											{
												...
												handler : function() {
													Ext
															.getCmp("startCaseTreePanel").root
															.expand(true);
												},
												scope : this
											},
									...
									tbar : [
											{
												...
												listeners : {
													render : function(f) {
														Ext
																.getCmp("documentsTreePanel").filter = new Ext.tree.TreeFilter(
																this,
																{
																	clearBlank : true,
																	autoClear : true
