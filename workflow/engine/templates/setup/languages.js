...
var infoGrid = new Ext.grid.GridPanel( {
  ...
  height : 140,
  width : 800,
  title : 'Languages for Processmaker Environment',
  stateful : true,
  stateId : 'grid',
  ...
  columns : [
    {
      ...
      renderer: function (value, p, r){
        if( r.data.DEFAULT == '1' )
          return String.format("{0} <font color=green style='font-size:9px'>({1})</font>", value, TRANSLATIONS.ID_PREDETERMINED);
        else 
          return value;
      }
    }, {
          ...
          items: [
            new Ext.FormPanel({
              ...
              items: [{
                  ...
                  id: 'form-file',
                  emptyText: 'Select Translation .po file',
                  fieldLabel: 'File',
