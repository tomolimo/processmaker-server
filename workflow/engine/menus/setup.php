 ...
 */
  ...
  if ($RBAC->userCanAccess('PM_SETUP_ADVANCE') == 1) {
    $G_TMP_MENU->AddIdRawOption('LANGUAGES', 'languages',   G::LoadTranslation('ID_LANGUAGES'), 'icon-language.png', '', 'admToolsContent');
    $G_TMP_MENU->AddIdRawOption('PLUGINS',   'pluginsList', 'Plugins', 'icon-plugins.png', '', 'admToolsContent');
    $G_TMP_MENU->AddIdRawOption('UPGRADE',   'upgrade',     G::LoadTranslation('ID_UPGRADE'), 'icon-system-upgrade.png', '', 'admToolsContent');
  }
  $G_TMP_MENU->AddIdRawOption('EMAILS',      'emails',      G::LoadTranslation('ID_EMAIL'), 'icon-email-settings.png', '', 'admToolsContent');
  $G_TMP_MENU->AddIdRawOption('WEBSERVICES', 'webServices', G::LoadTranslation('ID_WEB_SERVICES'), 'icon-webservices.png', '', 'admToolsContent');
  $G_TMP_MENU->AddIdRawOption('SKINS',       'skinsList', G::LoadTranslation('ID_SKINS'), 'icon-skins.png', '', 'admToolsContent');
  
  $G_TMP_MENU->AddIdRawOption('LOGO',        'uplogo', G::LoadTranslation('ID_LOGO'), 'icon-pmlogo.png', '', 'admToolsContent' );
