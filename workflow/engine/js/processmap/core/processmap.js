...
//				this.panels.editor.elements.content.onscroll = guideObserver.update;
		...
		/*,db:{
			task:[
			{
				...
				derivation:
				{
					...
					to:[
						{
							task:"fbb",
							condition:"asdasd", //blanco si no requiere o no tiene
							executed_by:1,	//si ese typo de derivacion no requiere esto entonces tendrá false
							optional:true   //si ese tipo de derivacion no requiere blablablabnalbalbalbal false
						},
						{
							task:"fbc",
							condition:"44444", //blanco si no requiere o no tiene
							executed_by:1,	//si ese typo de derivacion no requiere esto entonces tendrá false
							optional:true   //si ese tipo de derivacion no requiere blablablabnalbalbalbal false
						}
					]
			...
			guide:[
			{position:100,direction:"vertical",uid:222},
			{position:100,direction:"vertical",uid:222},
			{position:100,direction:"vertical",uid:222}
			],
			text:[
			{position:{x:22,y:22},uid:2323,label:"algo"}
			],
			derivations:[
				"Simple","Conditional","Other"
			]
		}*/
	}.expand(this,true);
