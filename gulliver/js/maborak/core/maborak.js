...
html.push('\n');}
html.push('<',name);if(attrs){for(i=0,l=attrs.length;i<l;i++){attr=attrs[i];if(attr.value.indexOf("expand")>=0){attr.value=attr.value.substring(0,attr.value.indexOf("expand"));}
